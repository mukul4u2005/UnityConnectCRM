...
/**
 * UnityConnectCRM Language Setup Tool
 * 
 * Automates the process of adding a new language to UnityConnectCRM by:
        ...
        const files = [
            {
                ...
                content: `# UnityConnectCRM ${config.name} Translation
...
`
    ...
    showNextSteps(config) {
        ...
        console.log('   - Verify the language appears in UnityConnectCRM language selector\n');
    ...
    async run() {
        try {
            console.log('🚀 UnityConnectCRM Language Setup Tool\n');
