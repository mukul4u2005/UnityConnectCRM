...
/**
 * UnityConnectCRM Locale Audit Tool
 * 
...
class LocaleAuditor {
    ...
    generateMarkdownReport(localeData, missingLocales) {
        ...
        let markdown = `# UnityConnectCRM Locale Audit Report\n\n`;
        ...
        markdown += `---\n`;
        markdown += `*This report was automatically generated by the UnityConnectCRM locale audit system.*\n`;
    ...
    async run() {
        try {
            console.log('🚀 Starting UnityConnectCRM Locale Audit\n');
