...
/**
 * UnityConnectCRM Term Extraction Script
 * 
 * Extracts all translatable terms from UnityConnectCRM for POEditor upload:
    ...
    async run() {
        try {
            ...
            if (dbTermsFile && this.fileExists(dbTermsFile)) {
                ...
                this.createFile(this.messagesFile, '# UnityConnectCRM locale file\n');
            }
