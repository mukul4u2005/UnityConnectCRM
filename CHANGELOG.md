...
### Other Changes
* Temple Info upgrade issues  by @DawoudIO in https://github.com/ChurchCRM/CRM/pull/7294
...
- CAN'T EDIT OR DELETE EVENTS FROM Listing All Temple Events [#6476](https://github.com/ChurchCRM/CRM/issues/6476)
...
- UnityConnectCRM 4.5.0 throws Fatal error while running setup [#6072](https://github.com/ChurchCRM/CRM/issues/6072)
...
NOTE: If you are using the Google Maps API keys, you will need to re-enter your API keys after installing this release.  Previous versions of UnityConnectCRM did not separate the geocoding keys from the JavaScript maps keys (which is against Google's best practice recommendations).  Please review the UnityConnectCRM geographic wiki for more details: https://github.com/ChurchCRM/CRM/wiki/Geographic
