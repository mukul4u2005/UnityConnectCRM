    ...
    <div className="col-lg-12">
        <div className="box" id="TwoFAEnrollmentSteps">
          <div className="box-body">
            <p>
              {window.i18next.t(
                "Enrolling your UnityConnectCRM user account in Two Factor Authention provides an additional layer of defense against bad actors trying to access your account.",
              )}
            </p>
            <p>
              {window.i18next.t(
            ...
            <div className="callout callout-warning">
              <p>
                {window.i18next.t(
                  "To prevent being locked out of your UnityConnectCRM account, please ensure you're ready to complete two factor enrollment before clicking begin",
                )}
              </p>
            </div>
            <ul>
