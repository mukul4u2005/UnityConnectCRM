        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <p class="mb-0"><?= gettext('Orphaned files are PHP or JavaScript files that exist on your server but are not part of the official UnityConnectCRM release. These files may be leftover from previous versions and could pose security risks if they contain outdated code with vulnerabilities.') ?></p>
                </div>
                ...
                <?php if ($hasOrphanedFiles): ?>
                    ...
                    <div class="alert alert-warning mt-3">
                        ...
                        <p class="mb-0"><?= gettext('These files were likely part of an older UnityConnectCRM version and were not cleaned up during a previous upgrade. Deleting them will improve your system security.') ?></p>
                    </div>
                <?php else: ?>
                    <div class="alert alert-success">
                        <i class="fa fa-check-circle mr-2"></i>
                        <strong><?= gettext('No Orphaned Files Found') ?></strong>
                        <p class="mb-0 mt-2"><?= gettext('Your UnityConnectCRM installation is clean. All files on the server match the official release.') ?></p>
                    </div>
                <?php endif; ?>
