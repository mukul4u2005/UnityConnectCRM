            ...
            <div class="card-body">
                ...
                <?php if ($isUpdateAvailable): ?>
                    <div class="alert alert-info mb-0" style="background-color: #d1ecf1; border-color: #bee5eb; color: #0c5460;">
                        ...
                        <?= gettext('A new version of UnityConnectCRM is available for installation.') ?>
                    </div>
                <?php else: ?>
                    <div class="alert alert-success mb-0" style="background-color: #d4edda; border-color: #c3e6cb; color: #155724;">
                        ...
                        <?= gettext('Your UnityConnectCRM installation is running the latest version.') ?>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div id="upgrade-stepper" class="bs-stepper">
                    ...
                    <div class="bs-stepper-content">
                        ...
                        <div id="step-warnings" class="content p-4" role="tabpanel" aria-labelledby="step-warnings-trigger">
                            ...
                            <?php if ($integrityCheckFailed): ?>
                                <div class="alert alert-warning">
                                    ...
                                    <hr>
                                    <p><?= gettext("Some UnityConnectCRM system files may have been modified since the last installation.") ?> 
                            ...
                            <?php if ($hasOrphanedFiles && isset($integrityCheckData['orphanedFiles']) && count($integrityCheckData['orphanedFiles']) > 0): ?>
                                <div class="alert alert-danger mt-3">
                                    ...
                                    <hr>
                                    <p><?= gettext("The following files exist on your server but are NOT part of the official UnityConnectCRM release. These may be leftover from previous versions and could pose security risks.") ?></p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="alert alert-warning mt-3 mb-0">
                                                <small>
                                                    ...
                                                    <?= gettext('These files were likely part of an older UnityConnectCRM version and were not cleaned up during a previous upgrade. They may contain outdated code with security vulnerabilities.') ?>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="step-apply" class="content p-4" role="tabpanel" aria-labelledby="step-apply-trigger">
                            ...
                            <p class="text-muted"><?= gettext('Download the latest release and apply it to your UnityConnectCRM installation.') ?></p>
                        ...
                        <div id="step-complete" class="content p-4" role="tabpanel" aria-labelledby="step-complete-trigger">
                            <div class="text-center py-5">
                                ...
                                <p class="lead text-muted"><?= gettext('Your UnityConnectCRM installation has been successfully upgraded.') ?></p>
