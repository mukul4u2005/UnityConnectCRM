    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3"><?= gettext('Complete these essential setup tasks to get UnityConnectCRM running smoothly:') ?></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <p class="small mb-3"><?= gettext('Import sample families, people, and groups to explore UnityConnectCRM with realistic data.') ?></p>
