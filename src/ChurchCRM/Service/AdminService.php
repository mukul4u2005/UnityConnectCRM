...
class AdminService
{
    ...
    public function getSetupTasks(): array
    {
        ...
        // Check if temple name is still default
        if (SystemConfig::getValue('sTempleName') === 'Some Church') {
            $tasks[] = [
                'title' => gettext('Update Temple Name'),
                'desc' => gettext('Temple name is set to default value'),
