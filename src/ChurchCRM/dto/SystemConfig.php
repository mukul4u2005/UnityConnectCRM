...
class SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'iTempleLatitude'                      => new ConfigItem(45, 'iTempleLatitude', 'number', '', gettext('Latitude of the church, used to center the Google map')),
            'iTempleLongitude'                     => new ConfigItem(46, 'iTempleLongitude', 'number', '', gettext('Longitude of the church, used to center the Google map')),
            ...
            'sTaxReport3'                          => new ConfigItem(1013, 'sTaxReport3', 'text', 'If you have any questions or corrections to make to this report, please contact the temple at the above number during business hours, 9am to 4pm, M-F.', gettext('Verbage for bottom line of tax report.')),
            ...
            'sConfirm1'                            => new ConfigItem(1019, 'sConfirm1', 'text', 'This letter shows the information we have in our database with respect to your family.  Please review, mark-up as necessary, and return this form to the temple office.', gettext('Verbage for the database information confirmation and correction report')),
            'sConfirm2'                            => new ConfigItem(1020, 'sConfirm2', 'text', 'Thank you very much for helping us to update this information.  If you want on-line access to the temple database please provide your email address and a desired password and we will send instructions.', gettext('Verbage for the database information confirmation and correction report')),
            ...
            'sConfirm4'                            => new ConfigItem(1022, 'sConfirm4', 'text', '[  ] I no longer want to be associated with the temple (check here to be removed from our records).', gettext('Verbage for the database information confirmation and correction report')),
            ...
            'sTempleCountry'                       => new ConfigItem(1047, 'sTempleCountry', 'choice', '', '', '', json_encode(['Choices' => Countries::getNames()], JSON_THROW_ON_ERROR)),
