...
class Bootstrapper
{
    ...
    /**
     * Initialize the UnityConnectCRM system
     * 
    ...
    public static function init(string $sSERVERNAME, $dbPort, string $sUSER, string $sPASSWORD, string $sDATABASE, string $sRootPath, bool $bLockURL, array $URL): void
    {
        ...
        self::$bootStrapLogger->debug("Starting UnityConnectCRM");
    ...
    {
        self::$bootStrapLogger->debug("Checking for UnityConnectCRM Database tables");
        try {
    ...
    {
        self::$bootStrapLogger->info("Installing UnityConnectCRM Schema");
        $connection = Propel::getConnection();
        $version = new Version();
        ...
        $version->save();
        self::$bootStrapLogger->info("Installed UnityConnectCRM Schema version: " . VersionUtils::getInstalledVersion());
    }
    /**
