...
class Menu
{
    ...
    private static function getEventsMenu(): MenuItem
    {
        ...
        $eventsMenu->addSubMenu(new MenuItem(gettext('Add  Temple Event'), 'EventEditor.php', AuthenticationManager::getCurrentUser()->isAddEventEnabled()));
        $eventsMenu->addSubMenu(new MenuItem(gettext('List Temple Events'), 'ListEvents.php'));
