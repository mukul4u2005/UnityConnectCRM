...
class Menu
{
    ...
    private static function getEventsMenu(bool $isAddEventEnabled): MenuItem
    {
        ...
        $eventsMenu->addSubMenu(new MenuItem(gettext('List Temple Events'), 'ListEvents.php', true, 'fa-list'));
        $eventsMenu->addSubMenu(new MenuItem(gettext('Add Temple Event'), 'EventEditor.php', $isAddEventEnabled, 'fa-plus-circle'));
