...
$sPageTitle = 'UnityConnectCRM – Setup';

require_once __DIR__ . '/header.php';
?>
<div class="container-fluid">
<div class="jumbotron text-center">
    <h1 class="display-4">Welcome to UnityConnectCRM Setup Wizard</h1>
    <p class="lead">Let's get your temple management system configured and ready to use.</p>
</div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning alert-dismissible fade show" role="alert" id="prerequisites-war">
                                    ...
                                    <p class="mb-0 mt-1">Some server requirements are not satisfied. UnityConnectCRM may not function correctly.</p>
                                </div>
