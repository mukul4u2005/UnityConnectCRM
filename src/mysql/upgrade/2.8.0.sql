...
update config_cfg set cfg_name = 'iTempleLatitude' where cfg_name = 'nChurchLatitude';
update config_cfg set cfg_name = 'iTempleLongitude' where cfg_name = 'nChurchLongitude';
