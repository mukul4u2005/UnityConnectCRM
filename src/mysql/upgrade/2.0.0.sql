...
VALUES
  ...
  (999, 'bRegistered', '0', 'boolean', '0',
   'UnityConnectCRM has been registered.  The UnityConnectCRM team uses registration information to track usage.  This information is kept confidential and never released or sold.  If this field is true the registration option in the admin menu changes to update registration.', 'General', NULL),
  (2000, 'mailChimpApiKey', '', 'text', '', 'see https://mailchimp.com/help/about-api-keys/', 'General', NULL),
  (1034, 'sTempleChkAcctNum', '111111111', 'text', '', 'Temple Checking Account Number', 'ChurchInfoReport', NULL);
UPDATE user_usr
