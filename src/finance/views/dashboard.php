                ...
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center px-0">
                            <div class="mr-3">
                                <?php 
                                $hasTempleInfo = !empty(SystemConfig::getValue('sTempleName')) && !empty(SystemConfig::getValue('sTempleAddress'));
                                ?>
                                <?php if ($hasTempleInfo): ?>
                                <span class="badge badge-success rounded-circle p-2"><i class="fa-solid fa-check"></i></span>
                                <?php else: ?>
                                <span class="badge badge-danger rounded-circle p-2"><i class="fa-solid fa-times"></i></span>
                                <?php endif; ?>
                            ...
                            <div class="flex-grow-1">
                                <strong><?= gettext('Temple Information') ?></strong>
                                <p class="mb-0 small text-muted"><?= gettext('Verify temple name, address, and contact info appears on tax statements.') ?></p>
                            </div>
                            <div>
