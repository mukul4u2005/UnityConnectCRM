        ...
        <div class="card-body">
            <div class="d-flex align-items-start">
                ...
                <div>
                    ...
                    <p class="text-muted mb-2"><?= gettext('Your UnityConnectCRM installation needs a database upgrade to match the installed software version. This operation will apply schema and data migrations. Please ensure you have a recent backup before proceeding.') ?></p>
