...
$sTempleName = InputUtils::legacyFilterInput($_POST['sTempleName']);
$sDirectoryDisclaimer = InputUtils::legacyFilterInput($_POST['sDirectoryDisclaimer']);
$sTempleAddress = InputUtils::legacyFilterInput($_POST['sTempleAddress']);
$sTempleCity = InputUtils::legacyFilterInput($_POST['sTempleCity']);
$sTempleState = InputUtils::legacyFilterInput($_POST['sTempleState']);
$sTempleZip = InputUtils::legacyFilterInput($_POST['sTempleZip']);
$sTemplePhone = InputUtils::legacyFilterInput($_POST['sTemplePhone']);
