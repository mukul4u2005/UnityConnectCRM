...
if ($output === 'pdf') {
    ...
    $pdf->writeAt(SystemConfig::getValue('leftX'), $curY, SystemConfig::getValue('sTempleName'));
    $curY += SystemConfig::getValue('incrementY');
    $pdf->writeAt(SystemConfig::getValue('leftX'), $curY, SystemConfig::getValue('sTempleAddress'));
    $curY += SystemConfig::getValue('incrementY');
    $pdf->writeAt(SystemConfig::getValue('leftX'), $curY, SystemConfig::getValue('sTempleCity') . ', ' . SystemConfig::getValue('sTempleState') . '  ' . SystemConfig::getValue('sTempleZip'));
    $curY += SystemConfig::getValue('incrementY');
    $pdf->writeAt(SystemConfig::getValue('leftX'), $curY, SystemConfig::getValue('sTemplePhone') . '  ' . SystemConfig::getValue('sTempleEmail'));
