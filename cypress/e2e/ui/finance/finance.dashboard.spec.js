...
describe("Finance Dashboard", () => {
    ...
    it("should display Tax Year Reporting Checklist", () => {
        ...
        cy.contains("Temple Information");
    ...
    it("should navigate to settings from Temple Information checklist item", () => {
        cy.visit("/finance/");

        // Find the Settings button in the Temple Information row
        cy.contains("Temple Information")
